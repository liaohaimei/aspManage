...
if Page=1 then 
	This_Func_Get_Html_=This_Func_Get_Html_& "<a color="&nonLinkColor_&" title=""首页"">"&toF_&"</a> " &vbNewLine
Else 
...
Else 
	This_Func_Get_Html_=This_Func_Get_Html_& "<a color="&nonLinkColor_&" title=""上一页"">"&toP1_&"</a> "  &vbNewLine
End If 
...
Else 
	This_Func_Get_Html_=This_Func_Get_Html_& "<a color="&nonLinkColor_&" title=""下一页"">"&toN1_&"</a> "  &vbNewLine
End If 
...
Else 
	This_Func_Get_Html_=This_Func_Get_Html_& "<a color="&nonLinkColor_&" title=""尾页"">"&toL_&"</a>"  &vbNewLine
End If 
