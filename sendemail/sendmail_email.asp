...
<%
 ...
 strContent= strContent&"订阅E-mail："
 strContent= strContent&""&Request("email")&""
 strContent= strContent&"<br>"
 
 strContentmy=strContentmy&"Newsletter subscription success"
  ...
  strEmailmyself		= Request("email") '这是收信的地址,可以改为其它的邮箱
  strMailAddress = "smtp.126.com" '我司企业邮局地址，请使用 mail.您的域名
  strMailUser	 = "chinawcwcom@126.com" '我司企业邮局用户名
  strMailPass	 = decode("007700730070006A0078006A0061") '邮局用户密码
...
response.end
  ...
  Call SendAction (strSubject,strEmailmyself,strSender,strContentmy)
end if
