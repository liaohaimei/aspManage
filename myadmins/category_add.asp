  ...
  <div class="container-fluid">
              ...
              <div>
                ...
                <div class="form-group">
                  ...
                  <div>
                    <input type="text" class="form-control" id="input-name" name="n_name"></div>
                </div>

                <div class="form-group">
                  <label for="input-cname">别名</label>
                  <div>
                    <input type="text" class="form-control" id="input-cname" name="n_cname"></div>
                </div>
                <div class="form-group">
...
if action="add" then
insertSql = "insert into yii_Category(n_name,n_cname,n_description) values ('"&p_name&"','"&p_model&"','"&p_description&"')"
