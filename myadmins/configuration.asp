    ...
    <div id="right_content">
      <div id="main_content">
        ...
        <div class="nav_content">
		  ...
		  %>
          <form method="post" action="?action=save&acttype=edit&id=<%=id%>"  name="addform" onSubmit="return validateform()">
                      ...
                      <tbody>
                        ...
                        <tr style="display:none;">
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <input id="m_name" name="m_name" size="60"  value="网站基本配置" />
                        ...
                        <tr>
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px; border-left:solid #dddddd 1px;"><table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="right">发送邮箱服务器:</td>
                              </tr>
                            </table></td>
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <input id="m_smtpservice" name="m_smtpservice" size="60"  value="<%=rsObj("smtpservice")%>" />
                            &nbsp;如:163邮箱发送邮件服务器&quot;smtp.163.com&quot;</td>
                        </tr>
                        <tr>
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px; border-left:solid #dddddd 1px;"><table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="right">发送邮箱用户名:</td>
                              </tr>
                            </table></td>
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <input id="m_smtpuser" name="m_smtpuser" size="60"  value="<%=rsObj("smtpuser")%>" />
                            &nbsp;</td>
                        </tr>
                        <tr>
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px; border-left:solid #dddddd 1px;"><table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="right">发送邮箱密码:</td>
                              </tr>
                            </table></td>
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <input type="password" id="m_smtppassword" name="m_smtppassword" size="60"  value="" />
                            &nbsp;注：为空则不修改密码</td>
                        </tr>
                      <tr>
...
Sub saveInfos
	...
	dim updateSql
	dim m_name:m_name=ReplaceSymbols(getForm("m_name","post"))
	...
	dim m_smtpservice:m_smtpservice=getForm("m_smtpservice","post")
	dim m_smtpuser:m_smtpuser=getForm("m_smtpuser","post")
	dim m_smtppassword:m_smtppassword=getForm("m_smtppassword","post")
	...
	select case  actType
		case "edit"
			...
			if m_smtppassword<>"" then
			passwordstr=",smtppassword='"&m_smtppassword&"'"
			end if
			updateSql = "NavName='"&m_name&"',NavNameen='"&m_nameen&"',NavNamejp='"&m_namejp&"',Tel='"&m_Tel&"',Address='"&m_Address&"',Addressen='"&m_Addressen&"',Fax='"&m_Fax&"',Email='"&m_Email&"',BjEmail='"&m_BjEmail&"',MesEmail='"&m_MesEmail&"',smtpservice='"&m_smtpservice&"',smtpuser='"&m_smtpuser&"'"&passwordstr&",Class_pic='"&m_class_pic&"',PageTitle='"&m_PageTitle&"',PageTitleen='"&m_PageTitleen&"',PageTitlejp='"&m_PageTitlejp&"',Keywords='"&m_Keywords&"',Keywordsen='"&m_Keywordsen&"',Keywordsjp='"&m_Keywordsjp&"',Copyright='"&m_Copyright&"',Copyrighten='"&m_Copyrighten&"',Copyrightjp='"&m_Copyrightjp&"',Descriptions='"&m_Descriptions&"',Descriptionsen='"&m_Descriptionsen&"',Descriptionsjp='"&m_Descriptionsjp&"',[Describe]='"&m_description&"',[Describeen]='"&m_descriptionen&"',[Describejp]='"&m_descriptionjp&"'"
			updateSql = "update {pre}Configuration set "&updateSql&" where ID="&m_id
			conn.db  updateSql,"execute"
			alertMsg "","?action=save&id="&m_id
	end select
End Sub
%>
