...
sub upload()
	...
	if upload.err > 0 then
		...
		up_formPath="../../Upload/flash/"'upload.form("filepath")
...
Private Function CheckFileExt (up_fileExt)
	dim Forumupload,i
	Forumupload=split("jpg|gif|png|bmp|rar|doc|xls|pdf|swf","|")
...
Private sub checksave(inputname)
	...
	response.write "<script>parent.document.getElementById("""& inputname &""").value='Upload/flash/"&filename&"'</script>"
end Sub
