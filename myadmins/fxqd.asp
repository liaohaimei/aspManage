...
Sub main
	...
	sqlStr = replace(replace("select ID,p_name,Hits,p_ID,SortID,CreateDate,ord,isnew,ishot,isShow,IsShowen,IsShowjp,CreateDate,p_img from {pre}Fxqd "&whereStr&orderStr,"where and","where"),"where order","order")
...
%>
		...
		%>
                        <tr>
                          ...
                          <td align="center" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;"><table width="100" height="100" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                  ...
                  <td align="left"><table width="100%" cellpadding="0" cellspacing="0" id="RiseList">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <select name="m_type" id="m_type"  >
                              ...
                              <%selectTypeEdit 11,Cint(getForm("cid","get")),parentid%>
                            </select>
                            &nbsp;&nbsp;<font color="red">＊</font> &nbsp;&nbsp; 
                        ...
                        <tr>
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px; border-left:solid #dddddd 1px;"><table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="right">请选择代理产品:</td>
                              </tr>
                            </table></td>
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <label><input name="fx_1" type="checkbox" id="fx_1" value="yes">交流/直流电源</label>
                            <label><input name="fx_2" type="checkbox" id="fx_2" value="yes">轨道式</label>
                            <label><input name="fx_3" type="checkbox" id="fx_3" value="yes">模块型</label>
                            <label><input name="fx_4" type="checkbox" id="fx_4" value="yes">LED 电源</label>
                            <label><input name="fx_5" type="checkbox" id="fx_5" value="yes">19”机箱式</label>
                            <label><input name="fx_6" type="checkbox" id="fx_6" value="yes">基板型</label>
                            <label><input name="fx_7" type="checkbox" id="fx_7" value="yes">适配器</label>
                            <label><input name="fx_8" type="checkbox" id="fx_8" value="yes">直流/直流转换器</label>
                            <label><input name="fx_9" type="checkbox" id="fx_9" value="yes">充电器</label>
                            <label><input name="fx_10" type="checkbox" id="fx_10" value="yes">直流/交流逆变器</label>
                            </td>
                        </tr>
                        ...
                        <tr style="display:none;">
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <input id="m_p_links" name="m_p_links" size="36" /></td>
                        </tr>
                        <tr style="display:none;">
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px; border-left:solid #dddddd 1px;"><table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <input id="m_p_linksen" name="m_p_linksen" size="36" /></td>
                        </tr>
                        <tr style="display:none;">
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px; border-left:solid #dddddd 1px;"><table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
					...
					clickFn : function(url, title, width, height, border, align) {
                        ...
                        <tr style="display:none;">
                          ...
                          <td class="tbtr" style="padding:0px 8px 8px 8px;border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;"><fieldset class="images_box" style="padding:5px 5px 0px 5px;">
                              <legend>图片列表</legend>
                              <div id="J_enantiomersView"> </div>
                            </fieldset>
                            <input type="button" id="J_enantiomersImage" value="批量上传" />
                            <script>
			KindEditor.ready(function(K) {
				var editor = K.editor({
				  uploadJson : '../TextEditor/UltraEdit/asp/upload_json.asp',
				...
				K('#J_enantiomersImage').click(function() {
					editor.loadPlugin('multiimage', function() {
						editor.plugin.multiImageDialog({
							clickFn : function(urlList) {
								var div = K('#J_enantiomersView');
								K.each(urlList, function(i, data) {
			                            div.append('<div style="position:relative;border:#666666 1px solid;float:left;;margin-right:5px;margin-bottom:5px;"><a href="javascript:void(0)" onClick="this.parentNode.parentNode.removeChild(this.parentNode);" style="position:absolute;float:left;top:2px;left:2px; background:#FFFFFF; color:#FF0000;"><img src="images/del.gif" width="45" height="19" border="0"></a><img src="' + data.url.replace('/TextEditor/UltraEdit/asp/../../..', '') + '" height="60" border="0"><input type="hidden"  name="m_p_enantiomers"  value="' + data.url.replace('/TextEditor/UltraEdit/asp/../../..', '') + '"/></div>');
                            ...
                            <input type="button" id="enantiomersv" value="网络图片+本地图片" />
                            <script>
			KindEditor.ready(function(K) {
				var editor = K.editor({
				  uploadJson : '../TextEditor/UltraEdit/asp/upload_json.asp',
				...
				K('#enantiomersv').click(function() {
					editor.loadPlugin('image', function() {
						editor.plugin.imageDialog({
							imageUrl : K('#m_p_enantiomers').val(),
							clickFn : function(url, title, width, height, border, align) {
		                      var div = K('#J_enantiomersView');
		                     div.append('<div style="position:relative;border:#666666 1px solid;float:left;margin-right:5px;margin-bottom:5px;"><a href="javascript:void(0)" onClick="this.parentNode.parentNode.removeChild(this.parentNode);" style="position:absolute;float:left;top:2px;left:2px; background:#FFFFFF; color:#FF0000;"><img src="images/del.gif" width="45" height="19" border="0"></a><img src="' + url + '" height="60" border="0"><input type="hidden"  name="m_p_enantiomers"  value="' + url + '"/></div>');
								editor.hideDialog();
					...
					editor.loadPlugin('image', function() {
                        ...
                        <tr>
                          ...
                          <td class="tbtr" style="padding:0px 8px 8px 8px;border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;"><fieldset class="images_box" style="padding:5px 5px 0px 5px;">
                            ...
                            生成缩略图
                            （
                            <input name="small_img" type="radio" id="radio5" value="1" checked="checked" />
                            <label for="small_img">是
                              <input type="radio" name="small_img" id="radio6" value="0" />
                            </label>
                            否(删除缩略图)）&nbsp;&nbsp;&nbsp;&nbsp;最大宽高
...
Sub editProduct
	...
	sqlStr = "select *  from {pre}Fxqd where ID="&id
	set rsObj = conn.db(sqlStr,"records1")
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <select name="m_type" id="m_type"  >
                              <option value="">请选择资料分类</option>
                              <%selectTypeEdit 11,Cint(vtype),parentid%>
                            </select>
                            &nbsp;&nbsp;<font color="red">＊</font> &nbsp;&nbsp; 
                        ...
                        <tr>
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <label><input name="fx_1" type="checkbox" id="fx_1" value="yes" <% if rsObj("fx_1")=true then response.Write("checked") end if%>>交流/直流电源</label>
                            <label><input name="fx_2" type="checkbox" id="fx_2" value="yes" <% if rsObj("fx_2")=true then response.Write("checked") end if%>>轨道式</label>
                            <label><input name="fx_3" type="checkbox" id="fx_3" value="yes" <% if rsObj("fx_3")=true then response.Write("checked") end if%>>模块型</label>
                            <label><input name="fx_4" type="checkbox" id="fx_4" value="yes" <% if rsObj("fx_4")=true then response.Write("checked") end if%>>LED 电源</label>
                            <label><input name="fx_5" type="checkbox" id="fx_5" value="yes" <% if rsObj("fx_5")=true then response.Write("checked") end if%>>19”机箱式</label>
                            <label><input name="fx_6" type="checkbox" id="fx_6" value="yes" <% if rsObj("fx_6")=true then response.Write("checked") end if%>>基板型</label>
                            <label><input name="fx_7" type="checkbox" id="fx_7" value="yes" <% if rsObj("fx_7")=true then response.Write("checked") end if%>>适配器</label>
                            <label><input name="fx_8" type="checkbox" id="fx_8" value="yes" <% if rsObj("fx_8")=true then response.Write("checked") end if%>>直流/直流转换器</label>
                            <label><input name="fx_9" type="checkbox" id="fx_9" value="yes" <% if rsObj("fx_9")=true then response.Write("checked") end if%>>充电器</label>
                            <label><input name="fx_10" type="checkbox" id="fx_10" value="yes" <% if rsObj("fx_10")=true then response.Write("checked") end if%>>直流/交流逆变器</label>
                            </td>
                        </tr>
                        ...
                        <tr style="display:none;">
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <input id="m_p_links" name="m_p_links" size="36" value="<%=rsObj("p_links")%>" /></td>
                        </tr>
                        <tr style="display:none;">
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px; border-left:solid #dddddd 1px;"><table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <input id="m_p_linksen" name="m_p_linksen" size="36" value="<%=rsObj("p_linksen")%>" /></td>
                        </tr>
                        <tr style="display:none;">
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px; border-left:solid #dddddd 1px;"><table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                        ...
                        <tr>
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp; 
                            ...
                            <select name="m_p_material" id="m_p_material">
                              <option value="0" selected="selected">请选择</option>
                              <%=getNextClass(41,rsObj("p_material"))%>
                        ...
                        <tr>
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp; 
                            ...
                            <select name="m_p_materialen" id="m_p_materialen">
                              <option value="0" selected="selected">请选择</option>
                             <%=getNextClass(41,rsObj("p_materialen"))%>
                            </select></td>
                        </tr>
                        <tr style="display:none;">
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px; border-left:solid #dddddd 1px;"><table width="100%" cellpadding="0" cellspacing="0">
                        ...
                        <tr style="display:none;">
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp; 
                            ...
                            <select name="m_p_priceRange" id="m_p_priceRange">
                              <option value="0" selected="selected">请选择</option>
                              <%
Otherselect 13,rsObj("p_priceRange")
%>
                            </select></td>
                        </tr>
                        <tr style="display:none;">
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp; 
                            ...
                            <select name="m_p_priceRangeen" id="m_p_priceRangeen">
                              <option value="0" selected="selected">请选择</option>
                              <%
Otherselect 13,rsObj("p_priceRangeen")
%>
                            </select></td>
                        </tr>
                        <tr style="display:none;">
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp; 
                            ...
                            <select name="m_p_collection" id="m_p_collection">
                              <option value="0" selected="selected">请选择</option>
                              <%
Otherselect 12,rsObj("p_collection")
%>
                            </select></td>
                        </tr>
                        <tr style="display:none;">
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp; 
                            ...
                            <select name="m_p_collectionen" id="m_p_collectionen">
                              <option value="0" selected="selected">请选择</option>
                              <%
Otherselect 12,rsObj("p_collectionen")
%>
                            </select></td>
                        </tr>
                        <tr style="display:none;">
				...
				editor.plugin.imageDialog({
					...
					clickFn : function(url, title, width, height, border, align) {
                        ...
                        <tr style="display:none;">
                          ...
                          <td class="tbtr" style="padding:0px 8px 8px 8px;border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;"><fieldset class="images_box" style="padding:5px 5px 0px 5px;">
                              <legend>图片列表</legend>
                              <div id="J_enantiomersView">
                                <%
if not isnul(rsObj("p_enantiomers")) then 
	images=split(rsObj("p_enantiomers"),",")
	for j=0 to ubound(images)
	echo"<div style='position:relative;border:#666666 1px solid;float:left;;margin-right:5px;margin-bottom:5px;'><a href='javascript:void(0)' onClick='this.parentNode.parentNode.removeChild(this.parentNode);' style='position:absolute;float:left;top:2px;left:2px; background:#FFFFFF; color:#FF0000;'><img src='images/del.gif' width='45' height='19' border='0'></a><img src='"&images(j)&"' height='60' border='0'><input type='hidden'  name='m_p_enantiomers'  value='"&images(j)&"'/></div>"
	next
end if
%>
                              </div>
...
Sub saveProduct
	...
	dim m_p_enantiomers:m_p_enantiomers=ReplaceSymbols(getForm("m_p_enantiomers","post"))
	...
	dim m_fx_10
	if getForm("fx_10","post") = "yes" then
		m_fx_10=1
	else
		m_fx_10=0
	end if		
...
Sub delProduct
	...
	vtypeAndPic=conn.db("select p_smallimg from {pre}Fxqd where ID="&id,"array")
	vpic=vtypeAndPic(0,0)
	if len(vpic)>0 then  delFile "../"&vpic
	conn.db  "delete from {pre}Fxqd where id="&id,"execute"
...
Sub UpdateOrder
	...
	For i=0 To Ubound(ids)	
		updateSql = "update {pre}Fxqd Set ord="&trim(orders(i))&" Where ID="&trim(ids(i))	
		conn.db updateSql,"execute" 	
	Next
...
Sub delAll
	...
	if ids<>"" Then
	conn.db  "delete from {pre}Fxqd where id in("&ids&")","execute" 
	end if
	parentid = getForm("parentid","get")
	pid=getForm("pid","get")
	bid=getForm("bid","get")
...
'获取所有类别
function getNextClass(id,nowvalue)
set rsnn=conn.db("select * from {pre}Navigation where ParentID="&id&"  order by Sequence asc, id asc","records1")
if rsnn.eof or rsnn.bof then
else
do while not rsnn.eof
getNextClass=getNextClass&"<option value='"&rsnn("id")&"' disabled='disabled'>"&spaceNum("——",rsnn("DeepPath")-2)&""&rsnn("NavName")&"</option>"
if isNextNull(rsnn("id"))=true then
getNextClass=getNextClass&getNextClass(rsnn("id"),nowvalue)
end if
if isNextNull(rsnn("id"))=false then
getNextClass=getNextClass&getProItem(rsnn("id"),nowvalue)
end if
rsnn.movenext
loop
end if
rsnn.close : set rsnn=nothing
end function

'获取选项
function getProItem(id,nowvalue)
set rsnn=conn.db("select * from {pre}product where SortID="&id&" and IsShow=true   order by Ord asc, id asc","records1")
if rsnn.eof or rsnn.bof then
else
do while not rsnn.eof
if rsnn("id")+0=nowvalue+0 then
sel=" selected='selected'"
else
sel=""
end if
getProItem=getProItem&"<option value='"&rsnn("id")&"' "&sel&">"&rsnn("p_name")&"</option>"
rsnn.movenext
loop
end if
rsnn.close : set rsnn=nothing
...
function spaceNum(str,n)
for i=0 to n
spaceNum=spaceNum&str
next
end function

'判断是否有下级
function isNextNull(id)
set rsnn=conn.db("select * from {pre}Navigation where ParentID="&id&" ","records1")
if rsnn.recordcount=0 then
isNextNull=false
else
isNextNull=true
end if
