    ...
    <div id="right_content">
      <div id="main_content">
        ...
        <div class="nav_content" style="line-height:18px;">
          <h1>后台首页
            <%
				dim proID : proID=getForm("proID","get")
...
Sub main
	...
	sqlStr = replace(replace("select ID,p_name,p_model,Hits,p_ID,SortID,CreateDate,ord,isnew,ishot,isShow,IsShowen,IsShowjp,CreateDate,p_img from {pre}Product "&whereStr&orderStr,"where and","where"),"where order","order")
...
%>
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tbody>
                        <tr bgcolor="#e5e5e5">
                          ...
                          <td width="10%" align="left" valign="middle" style="border-top:solid #bbbbbb 1px;border-right:solid #bbbbbb 1px;">&nbsp;标题</td>
		...
		%>
                        <tr>
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;<%=GetProName(rsObj("p_name"))%> &nbsp;
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;<%=rsObj("p_model")%></td>
                          ...
                          <td align="middle" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;"><table width="100%" cellpadding="0" cellspacing="0">
                              <tbody>
                                <tr>
                                  <td align="center" colspan="3"><a href="?action=editadd&id=<%=m_id%>&parentid=<%=parentid%>&pid=<%=pid%>&bid=<%=bid%>&tid=<%=tid%>&sid=<%=sid%>&cid=<%=cid%>&uid=<%=uid%>&page=<%=page%>&keyword=<%=keyword%>&proID=<%=proID%>">添加相似资料</a></td>
                                </tr>
                                <tr>
                                  <td align="center"><a href="?action=edit&id=<%=m_id%>&parentid=<%=parentid%>&pid=<%=pid%>&bid=<%=bid%>&tid=<%=tid%>&sid=<%=sid%>&cid=<%=cid%>&uid=<%=uid%>&page=<%=page%>&keyword=<%=keyword%>&proID=<%=proID%>">修改</a></td>
                                  <td align="center">|</td>
...
Sub addProduct
%>
          <form method="post" action="?action=save&acttype=add&parentid=<%=parentid%>&pid=<%=pid%>&bid=<%=bid%>&tid=<%=tid%>&sid=<%=sid%>&cid=<%=cid%>&uid=<%=uid%>&keyword=<%=proID%>&proID=<%=proID%>"  name="addform" onSubmit="return validateform()">
...
%>
                        ...
                        <tr>
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            ...
                            <select name="m_nameen" id="m_nameen">
                              <option value="0" selected="selected">请选择</option>
<%
ColorsClass 3,0
%>
                        ...
                        <tr>
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <select name="m_type" id="m_type"  >
                              ...
                              <%selectTypeEdit 19,Cint(getForm("cid","get")),parentid%>
                            </select>
                            &nbsp;&nbsp;<font color="red">＊</font> &nbsp;&nbsp; 
                        ...
                        <tr style="display:none;">
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px; border-left:solid #dddddd 1px;"><table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="right">相关资料型号相关文章标签:</td>
                              </tr>
                            </table></td>
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                        ...
                        <tr style="display:none;">
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <input id="m_p_links" name="m_p_links" size="36" />
                            如：优酷地址：http://player.youku.com/player.php/Type/Folder/Fid/26057465/Ob/1/sid/XMTMyODUxNjU1Ng==/v.swf</td>
                        </tr>
                        <tr style="display:none;">
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px; border-left:solid #dddddd 1px;"><table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <input id="m_p_linksen" name="m_p_linksen" size="36" />
                            如：                            优酷地址：http://player.youku.com/player.php/Type/Folder/Fid/26057465/Ob/1/sid/XMTMyODUxNjU1Ng==/v.swf</td>
                        </tr>
                        <tr>
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px; border-left:solid #dddddd 1px;"><table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="right">标题(CN):</td>
                              </tr>
                            </table></td>
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
				...
				KindEditor.ready(function(K) {
					...
					K('#insertfile').click(function() {
						editor.loadPlugin('insertfile', function() {
                            ...
                            <input type="text" name="m_p_filepath" id="m_p_filepath" value="javascript:;" />
                            <input type="button" id="insertfile" value="选择文件" /></td>
                        </tr>
                        <tr style="display:none;">
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px; border-left:solid #dddddd 1px;"><table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="right">文件(EN):</td>
                              </tr>
                            </table></td>
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp; 
                            <script>
				...
				KindEditor.ready(function(K) {
					...
					K('#insertfile2').click(function() {
						editor.loadPlugin('insertfile', function() {
                            ...
                            <input type="text" name="m_p_filepathen" id="m_p_filepathen" value="javascript:;" />
...
Sub editProduct
	...
	vtype = rsObj("SortID")
%>
          <form method="post" action="?action=save&acttype=edit&parentid=<%=parentid%>&pid=<%=pid%>&bid=<%=bid%>&tid=<%=tid%>&sid=<%=sid%>&cid=<%=cid%>&uid=<%=uid%>&keyword=<%=proID%>&proID=<%=proID%>"  name="addform" onSubmit="return validateform()">
            <div class="nav_tools"><span class="save">
              <input type="submit" value="保存" class="but" onclick="addsave()"/>
              </span><span class="back"><a href="<%=request.ServerVariables("HTTP_REFERER")%>">返回</a></span><span class="nav_tools_right"></span></div>
            <div class="table">
...
%>
                        ...
                        <tr>
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <select name="m_type" id="m_type"  >
                              <option value="">请选择资料分类</option>
                              <%selectTypeEdit 19,Cint(vtype),parentid%>
                            </select>
                            &nbsp;&nbsp;<font color="red">＊</font> &nbsp;&nbsp; 
...
PathFieldDelete(m_p_img)
	...
	select case  actType
		...
		case "add" 
			...
			selectMsg "添加成功,是否继续添加","?action=add&parentid="&parentid&"&pid="&pid&"&bid="&bid&"&tid="&tid&"&sid="&sid&"&cid="&cid&"&uid="&uid&"&keyword="&proID&"&proID="&proID,"?parentid="&parentid&"&pid="&pid&"&bid="&bid&"&tid="&tid&"&sid="&sid&"&cid="&cid&"&uid="&uid&"&keyword="&proID&"&proID="&proID
	end select
End Sub
...
Sub UpdateOrder
	...
	alertMsg "更新排序成功","?page="&page&"&order="&order&"&parentid="&parentid&"&pid="&pid&"&bid="&bid&"&tid="&tid&"&sid="&sid&"&cid="&cid&"&uid="&uid&"&keyword="&proID&"&proID="&proID
End Sub
...
Sub delAll
	...
	alertMsg "","?page="&page&"&order="&order&"&parentid="&parentid&"&pid="&pid&"&bid="&bid&"&tid="&tid&"&sid="&sid&"&cid="&cid&"&uid="&uid&"&keyword="&proID&"&proID="&proID
End Sub
...
sub ColorsClass(pm,nowvalue)
proID=request.QueryString("proID")
set rsa=conn.db("select * from {pre}Navigation where id="&pm&" ","records1")
if rsa.recordcount>0 then
set rs=conn.db("select * from {pre}Product where SortID in("&rsa("ChildPath")&") and isShow=true   order by Ord asc,id desc","records1")
if rs.eof or rs.bof then
else
do while not rs.eof
if ""&rs("id")&""=""&nowvalue&"" or ""&rs("id")&""=""&proID&"" then
sel=" selected='selected'"
else
sel=""
end if
echo"<option value='"&rs("id")&"' "&sel&">"&rs("p_name")&"</option>"
rs.movenext
loop
end if
rs.close : set rs=nothing
...
Function GetProName(id)
    dim sqlStr,rsObj
	sqlStr= "select p_name from {pre}Product where ID="&id&""
	set rsObj = conn.db(sqlStr,"records1")
	if not rsObj.eof then GetProName=rsObj(0) else GetProName="未知"
	rsObj.close
	set rsObj = nothing
End Function
%>
