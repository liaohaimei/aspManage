...
%>
		...
		%>
                        <tr>
                          ...
                          <td align="center" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px; background:#FF6D06;"><table width="100" height="100" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="center" bgcolor="#FF6D06"><a href="?action=edit&id=<%=m_id%>&parentid=<%=parentid%>&pid=<%=pid%>&bid=<%=bid%>&tid=<%=tid%>&sid=<%=sid%>&cid=<%=cid%>&uid=<%=uid%>&page=<%=page%>"><img src="images/loading2.gif"  border="0" onload="setimg(this,100,100,'<%if rsObj("p_img")<>"" then%><%=img(Lbound(img))%><%else%>images/nopic.jpg<%end if%>')"/></a></td>
                              </tr>
                            </table></td>
                        ...
                        <tr>
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <select name="m_type" id="m_type"  >
                              ...
                              <%selectTypeEdit 13,Cint(getForm("cid","get")),parentid%>
                            </select>
                            &nbsp;&nbsp;<font color="red">＊</font> &nbsp;&nbsp; 
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <select name="m_type" id="m_type"  >
                              <option value="">请选择资料分类</option>
                              <%selectTypeEdit 13,Cint(vtype),parentid%>
                            </select>
                            &nbsp;&nbsp;<font color="red">＊</font> &nbsp;&nbsp; 
