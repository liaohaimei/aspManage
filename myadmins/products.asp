...
Sub main
	...
	sqlStr = replace(replace("select ID,p_name,Hits,p_ID,SortID,CreateDate,ord,isnew,ishot,isShow,IsShowen,IsShowjp,CreateDate,p_img,p_material from {pre}Product "&whereStr&orderStr,"where and","where"),"where order","order")
...
function setimg(ImgD,w,h,url)
{
	...
	image.src=url;
          ...
          <form method="post" name="Productlistform">
            <div class="nav_tools"><span class="add"><a href="?action=add&parentid=<%=parentid%>&pid=<%=pid%>&bid=<%=bid%>&tid=<%=tid%>&sid=<%=sid%>&cid=<%=cid%>&uid=<%=uid%>">添加</a></span><span class="edit"><a href="javascript:document.Productlistform.action='?action=uorder&page=<%=page%>&order=<%=order%>&parentid=<%=parentid%>&pid=<%=pid%>&bid=<%=bid%>&tid=<%=tid%>&sid=<%=sid%>&cid=<%=cid%>&uid=<%=uid%>&keyword=<%=keyword%>';document.Productlistform.submit();">更新排序</a></span><span class="delete"><a href="javascript:document.Productlistform.action='?action=delall&page=<%=page%>&order=<%=order%>&parentid=<%=parentid%>&pid=<%=pid%>&bid=<%=bid%>&tid=<%=tid%>&sid=<%=sid%>&cid=<%=cid%>&uid=<%=uid%>&keyword=<%=keyword%>';document.Productlistform.submit();" onClick="return confirm('确定要删除选中数据')">批量删除</a></span><span class="nav_tools_right"></span><span class="add"><a href='javascript:void(0)' onClick='popAdd(<%=cid%>)'>批量添加</a></span></div>
            <div class="table">
...
%>
                    <table width="100%" cellpadding="0" cellspacing="0">
                      <tbody>
                        <tr bgcolor="#e5e5e5">
                          <td width="7%" align="left" valign="middle" style="border-top:solid #bbbbbb 1px;border-right:solid #bbbbbb 1px; border-left:solid #bbbbbb 1px;"><table width="70" cellpadding="0" cellspacing="0">
                              <tbody>
                                <tr>
                          ...
                          <td width="30%" align="left" valign="middle" style="border-top:solid #bbbbbb 1px;border-right:solid #bbbbbb 1px;">&nbsp;名称</td>
                          <td width="14%" align="left" valign="middle" style="border-top:solid #bbbbbb 1px;border-right:solid #bbbbbb 1px;">&nbsp;资料类别</td>
                          <td width="12%" align="left" valign="middle" style="border-top:solid #bbbbbb 1px;border-right:solid #bbbbbb 1px;"><table width="100%" cellpadding="0" cellspacing="0">
                              <tr>
                          ...
                          <td width="10%" align="center" valign="middle" style="border-top:solid #bbbbbb 1px;border-right:solid #bbbbbb 1px;">操作</td>
                        </tr>
                        <%
		...
		%>
                        <tr>
                          ...
                          <td align="middle" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;"><table width="100%" cellpadding="0" cellspacing="0">
                              <tbody>
                                <!--<tr>
                                  <td align="center" colspan="3"><a href="detailpar.asp?action=add&parentid=49&pid=&bid=&tid=&sid=&cid=49&uid=0&proID=<%=rsObj("id")%>">添加电气特性</a></td>
                                </tr>
                                <tr>
                                  <td align="center" colspan="3"><a href="detailpar.asp?parentid=49&pid=&bid=&tid=&sid=&uid=0&cid=49&keyword=<%=rsObj("id")%>&proID=<%=rsObj("id")%>">查看电气特性</a></td>
                                </tr>-->
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td align="center">|</td>
                                  <td align="center"><%if CheckSubData(m_id)=true then%><a href="?action=del&id=<%=m_id%>" onClick="return confirm('确定要删除吗')">删除</a><%else%><a href="detailpar.asp?parentid=49&pid=&bid=&tid=&sid=&uid=0&cid=49&keyword=<%=rsObj("id")%>&proID=<%=rsObj("id")%>" style="color:red;">先删除电气特性</a><%end if%></td>
                                </tr>
                              </tbody>
                            </table></td>
                        </tr>
                        ...
                        <tr>
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <select name="m_type" id="m_type"  >
                              ...
                              <%selectTypeEdit 6,Cint(getForm("cid","get")),parentid%>
                            </select>
                            &nbsp;&nbsp;<font color="red">＊</font> &nbsp;&nbsp;
					...
					K('#insertfile2').click(function() {
                        ...
                        <tr>
                          <td colspan="2" align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px; border-left:solid #dddddd 1px;"><div class="wrap">
                              <ul class="tabs">
                                <li class="active"><a href="#" title="产品描述(CN)">产品描述(CN)</a></li>
                                <li><a href="#" title="电气特性(CN)">电气特性(CN)</a></li>
                                <li><a href="#" title="输出特性(CN)">输出特性(CN)</a></li>
                                <li><a href="#" title="安规(CN)">安规(CN)</a></li>
                                <li><a href="#" title="产品描述(EN)">产品描述(EN)</a></li>
                                <li><a href="#" title="电气特性(EN)">电气特性(EN)</a></li>
                                <li><a href="#" title="输出特性(EN)">输出特性(EN)</a></li> 
                                <li><a href="#" title="安规(EN)">安规(EN)</a></li>
                               <!-- <li><a href="#" title="产品描述(JP)">产品描述(JP)</a></li>-->
                              </ul>
                              <div class="clear"></div>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            <select name="m_type" id="m_type"  >
                              <option value="">请选择资料分类</option>
                              <%selectTypeEdit 6,Cint(vtype),parentid%>
                            </select>
                            &nbsp;&nbsp;<font color="red">＊</font> &nbsp;&nbsp;
                        ...
                        <tr style="display:none;">
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            ...
                            <select name="m_p_material" id="m_p_material">
                              <option value="0" selected="selected">请选择</option>
                              <%
Otherselect2 10,rsObj("p_material")
%>
                            </select></td>
                        </tr>
                        <tr style="display:none;">
                          ...
                          <td align="left" style="border-top:solid #dddddd 1px;border-right:solid #dddddd 1px;">&nbsp;
                            ...
                            <select name="m_p_materialen" id="m_p_materialen">
                              <option value="0" selected="selected">请选择</option>
                              <%
Otherselect2 10,rsObj("p_materialen")
%>
                            </select></td>
                        </tr>
                        <tr style="display:none;">
...
sub Otherselect2(pm,nowvalue)
set rs=conn.db("select * from {pre}Navigation where ParentID="&pm&" ","records1")
if rs.eof or rs.bof then
else
do while not rs.eof
if ""&rs("id")&""=""&nowvalue&"" then
...
echo"<option value='"&rs("id")&"' "&sel&">"&rs("NavName")&"</option>"
rs.movenext
loop
end if
rs.close : set rs=nothing
...
function CheckSubData(id)
set rs=conn.db("select * from {pre}Product where p_name='"&id&"'","records1")
if rs.eof or rs.bof then
CheckSubData=true
else
CheckSubData=false
