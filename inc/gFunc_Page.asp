...
toPage_ = DelPage(GetLocationURL())&PageUrl("Page","submit,GetType,no-cache,_")

if Page=1 then 
	This_Func_Get_Html_=This_Func_Get_Html_& "<a class='first' color="&nonLinkColor_&" title=""首页"">"&toF_&"</a> " &vbNewLine
Else 
	This_Func_Get_Html_=This_Func_Get_Html_& "<a class='first' href="&RewriteRule(toPage_&"1")&" title=""首页"">"&toF_&"</a> " &vbNewLine
End If 
...
If StartPage>1 Then 
	This_Func_Get_Html_=This_Func_Get_Html_& "<a class='on-page' href="&RewriteRule(toPage_& Page - NaviLength) &" title=""上"&int_showNumberLink_&"页"">"&toP10_&"</a> "  &vbNewLine
Else 
	This_Func_Get_Html_=This_Func_Get_Html_& "<a class='on-page' color="&nonLinkColor_&" title=""上"&int_showNumberLink_&"页"">"&toP10_&"</a> "  &vbNewLine
End If 

If Page <> 1 and Page <>0 Then 
	This_Func_Get_Html_=This_Func_Get_Html_& "<a class='prev' href="&RewriteRule(toPage_&(Page-1))&"  title=""上一页"">"&toP1_&"</a> "  &vbNewLine
Else 
	This_Func_Get_Html_=This_Func_Get_Html_& "<a class='prev' color="&nonLinkColor_&" title=""上一页"">"&toP1_&"</a> "  &vbNewLine
End If 

For I=StartPage To EndPage 
	If I=Page Then 
		This_Func_Get_Html_=This_Func_Get_Html_& "<a class='current'>"&I&"</a>"  &vbNewLine
	Else 
		This_Func_Get_Html_=This_Func_Get_Html_& "<a href="&RewriteRule(toPage_&I)&">" &I& "</a>"  &vbNewLine
	End If 
	If I<>tPageCount Then This_Func_Get_Html_=This_Func_Get_Html_& vbNewLine
Next 

If Page <> Page_Rs.PageCount and Page <>0 Then 
	This_Func_Get_Html_=This_Func_Get_Html_& " <a class='next' href="&RewriteRule(toPage_&(Page+1))&" title=""下一页"">"&toN1_&"</a> "  &vbNewLine
Else 
	This_Func_Get_Html_=This_Func_Get_Html_& "<a class='next' color="&nonLinkColor_&" title=""下一页"">"&toN1_&"</a> "  &vbNewLine
End If 

If EndPage<tpagecount Then  
	This_Func_Get_Html_=This_Func_Get_Html_& " <a class='next-page' href="&RewriteRule(toPage_& Page + NaviLength) &"  title=""下"&int_showNumberLink_&"页"">"&toN10_&"</a> "  &vbNewLine
Else 
	This_Func_Get_Html_=This_Func_Get_Html_& " <a class='next-page' color="&nonLinkColor_&"  title=""下"&int_showNumberLink_&"页"">"&toN10_&"</a> "  &vbNewLine
End If 

if Page_Rs.PageCount<>Page then  
	This_Func_Get_Html_=This_Func_Get_Html_& "<a class='last' href="&RewriteRule(toPage_&Page_Rs.PageCount)&" title=""尾页"">"&toL_&"</a>"  &vbNewLine
Else 
	This_Func_Get_Html_=This_Func_Get_Html_& "<a class='last' color="&nonLinkColor_&" title=""尾页"">"&toL_&"</a>"  &vbNewLine
End If 
...
'This_Func_Get_Html_=This_Func_Get_Html_& p_&sp2_&" <i>"&Page_Rs.PageSize&"条/页</i>&nbsp;<i><span class=""tx"">"&sp2_&Page&"</span>/"&tPageCount&"</i>&nbsp;<i>共<span id='recordcount'>"&sp2_&Page_Rs.recordCount&"</span>条</i>"


'This_Func_Get_Html_=This_Func_Get_Html_& p_&sp2_&" <i>"&Page_Rs.PageSize&"/Page</i>&nbsp;<i><span class=""tx"">"&sp2_&Page&"</span>/"&tPageCount&"</i>&nbsp;<i>ALL：<span id='recordcount'>"&sp2_&Page_Rs.recordCount&"</span></i>"

'This_Func_Get_Html_=This_Func_Get_Html_& p_&sp2_&" <i>"&Page_Rs.PageSize&"レコード/ページ</i>&nbsp;<i><span class=""tx"">"&sp2_&Page&"</span>/"&tPageCount&"</i>&nbsp;<i>完全に<span id='recordcount'>"&sp2_&Page_Rs.recordCount&"</span>レコード</i>"
...
DelPage=ReplaceTest(url,"&Page=\d+","")
end function
